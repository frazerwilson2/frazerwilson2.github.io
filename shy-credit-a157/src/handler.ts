...
export async function handleSchedule(
  ...
  console.log('triggering battlebus');

  await fetch("https://fwitter.frazerwilson145.workers.dev/battlebus", {
    method: "POST",
    body: JSON.stringify({ "title":"foo","body":"bar", "id": 100})
  });

  return new Response(null, {
    status: 200,
    statusText: "Successfullydid thing",
  });
